    ...
    render () {
      ...
      return <main className="candidates">
        ...
        <section className="presentation__buttons">
          <button className="candidates__button" onClick={this.handlePrev}><i className="fas fa-angle-left"></i></button>
          <button className="candidates__button" onClick={this.handleNewMessage}>New message</button>
          <button className="candidates__button" onClick={this.handleNext}><i className="fas fa-angle-right"></i></button>
        </section>
